    ...
    '<header x-data="{ open: false }" class="sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800">',
      '<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">',
        '<div class="flex items-center justify-between h-16">',
          '<a href="' + BASE + '/" class="flex items-center gap-4 font-bold text-gray-900 dark:text-white text-sm sm:text-lg tracking-tight">',
            '<img src="/logo.webp" alt="Burrell Technology Services home" class="h-10 w-auto rounded-lg">',
